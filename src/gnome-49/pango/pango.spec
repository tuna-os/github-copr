...
Patch0:  pango-fixes-petite-caps.patch
...
%changelog
* Mon Jul 21 2025 Peng Wu  <pwu@redhat.com> - 1.56.4-2
- Fix a bug in petite caps handling

* Mon Jun 30 2025 Carlos Garnacho <cgarnach@redhat.com> - 1.56.4-1
- Update to 1.56.4

* Wed Mar 19 2025 nmontero <nmontero@redhat.com> - 1.56.3-1
- Update to 1.56.3
